#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Created by ZhangYichao on 2018/7/11
'''''
...
logger = Logger(logName='ftpHelp.txt',logLevel="DEBUG", logger="ftpHelp.py").getlog()
class ftpHelp:
...
if __name__ == '__main__':
    ...
    password = '123abc'  # 密码
    port = 21  # 端口号
    rootdir_local = '.' + os.sep + 'bak\DiseaseIndex.xml'  # 本地目录
    rootdir_remote = '/Config'  # 远程目录

    f = ftpHelp(hostaddr, username, password, rootdir_remote, port)
    f.login()
    f.download_file(rootdir_local, "DiseaseIndex.xml")
